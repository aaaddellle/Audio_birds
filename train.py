...
from minimagen.training import get_minimagen_parser, get_minimagen_dl_opts, \
    ...
    load_restart_training_parameters, load_testing_parameters, load_audio_to_image_dataset
...
#data_path = "C:\\Users\\Lenovo\\Desktop\\python\\audio_changed\\mel_digits"
data_path = "C:\\Users\\Lenovo\\Desktop\\python\\asimplest"
...
if args.TESTING:
    ...
    train_dataset, valid_dataset = load_audio_to_image_dataset(data_path, split_ratio = 0.8, transform = None, testset = False)
